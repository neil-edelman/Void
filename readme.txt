...
Player controls: left, right, up, space, F1 (fullscreen.) x --
report position, f -- framerate, p -- pause, 1 -- Gnuplot dump.
...
Build the static release of Glew (glew32s) and link it to Void. I
have tested it on MSVC10/13/15 and gcc Ubuntu (still trying MinGW.)
Make sure you turn off "Whole Program Optimization," on MSVC as it
will fail to make Glew. 'glew' in package managers.

http://glew.sourceforge.net/

Build the FreeGlut static library (freeglut_static.) 'freeglut' in
package managers.

http://freeglut.sourceforge.net/

Pre-compiling resources into generated code needs POSIX. Type 'make'
on a system that supports GNU99 extensions, (<make>, <make icon>,
or <make install>.) MSVC is the obvious compiler with lack of POSIX;
to make on that system, download a GCC, make, and then import all
the files, including the .c and .h in the build/ to MSVC. The main
programme code is C90.
