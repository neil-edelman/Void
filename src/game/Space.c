...
/** Space. Space objects define space and the objects theirin. Each sector has
 a list of stuff which is defined by float (x, y) and a next. You can call a
 subspace (window) and enumerate all objects within that subspace. Every space
 has a centre at (0, 0).
 <p>
 Sectors * granularity = space size.
 @author	Neil
 @version	3.2, 2015-09
 @since		3.2, 2015-09 */
